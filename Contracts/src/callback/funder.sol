...
contract Funder is AbstractCallback {
    ...
    constructor(address _service, address _callbackReceiver, address _reactiveReceiver, uint256 _refillValue, uint256 _refillThreshold) AbstractCallback(_service) payable {

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            See how ReactiveKeeper ensures critical blockchain infrastructure stays operational. From DeFi protocols to enterprise systems, discover the power of automated monitoring.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">
                Total value protected by ReactiveKeeper monitoring
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">
                Reactive contracts actively monitored
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300">
                Uptime for monitored contracts
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Whether you're running a DeFi protocol or building reactive applications, ReactiveKeeper ensures your contracts stay funded and operational.
          </p>

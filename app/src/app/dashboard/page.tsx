...
export default function DashboardPage() {
  ...
  const handleDeploymentSubmit = () => {
    ...
    console.log("Deploying monitor with:", deploymentForm);
    // In a real app: call API to deploy monitor
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-gray-600 dark:text-gray-300">USDC</span>
                <span className="font-medium text-gray-900 dark:text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-end">
            ...
            <div className="flex-1">
              ...
              <select
                value={selectedToken}
                onChange={(e) =>
                  setSelectedToken(e.target.value as "ETH" | "USDC" | "REACT")
                }
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mt-1">
                    Set up monitoring and refills for your Reactive + Callback
                    contracts.
                  </p>
                </div>
                <button
